...
public class Card{
    ...
    public Card(String a, int b, int c){
        ...
        g2d.setFont(new Font("Urbana", Font.PLAIN, 24));
        g2d.drawString(country, (int)((dim.getWidth()/1920.0)*50), (int)((dim.getHeight()/1080.0)*70));
        Image cardUnit = new ImageIcon("Blank.jpg").getImage();
        if (unit == 0){
            cardUnit = new ImageIcon("Infantry.jpg").getImage();
            cardUnit = resize(cardUnit, (int)((dim.getWidth()/1920.0)*190), (int)((dim.getWidth()/1920.0)*190));
        }
        if (unit == 1){
            cardUnit = new ImageIcon("Cavalry.jpg").getImage();
            cardUnit = resize(cardUnit, (int)((dim.getWidth()/1920.0)*190), (int)((dim.getWidth()/1920.0)*190));
        }
        if (unit == 2){
            cardUnit = new ImageIcon("Cannon.jpg").getImage();
            cardUnit = resize(cardUnit, (int)((dim.getWidth()/1920.0)*190), (int)((dim.getWidth()/1920.0)*190));
        }
        if (unit == 3){
            cardUnit = new ImageIcon("Wild.jpg").getImage();
            cardUnit = resize(cardUnit, (int)((dim.getWidth()/1920.0)*190), (int)((dim.getWidth()/1920.0)*190));
        }
